...
\end{itemize}
Overall, in terms of the timing and storage, the raw atomic feature extraction itself should be the upper bound of the whole atomic feature processing block, since $c$ itself could also be a composition of many factors depending on the method of the feature extractor.
