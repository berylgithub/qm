...
\begin{table}[H]
	\centering
	\caption{Fitting result using $E_\text{null}$. Null model refers to the model used for computing the reduced energies, RoSeMI refers to the Shepard model, KRR refers to the Gaussian kernel model, LLS is the linear least squares model, and NN is the neural network model. \textbf{MAE} is in kcal/mol.}
	\begin{tabular}{|l|l|}
		\hline
