...
The set of indices which refers to data points with known energies (or training data points) $K$ is chosen by the farthest-distance-algorithm variations, where the imposed challenge is $n_K = |K| = 100$, here we pick $N = |T| $ . The flow of the data selection is as the following:
\begin{itemize}
