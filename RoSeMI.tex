...
Meanwhile for the atomic features, the vector of atomic feature matrices needs to be stacked into one big matrix of atomic features then we can compute the ECDF.
