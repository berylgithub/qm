...
\begin{itemize}
    \item Compute the molecular features using ACSF (\at{cite Behler}). This would give a vector with 51 length for each atom.
    \item For each molecule, symmetrize the features by
        \begin{equation}
            \begin{split}
