...
\begin{abstract}
The \textit{ab initio} quantum chemistry methods are powerful tools to accurately compute quantum properties of molecules; however, they require massive computational resources.
...
With only 100 sample molecules for training, a mean absolute error of 5 kcal/mol is the best currently achieved \cite{qm9challenge} across the whole 130k test samples.
